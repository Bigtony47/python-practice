...
def higher_card(card_one, card_two:str):
...
def value_of_ace(card_one, card_two:str):
...
def is_blackjack(card_one, card_two: str):
...
def can_split_pairs(card_one, card_two:str):
...
def can_double_down(card_one, card_two:str):
